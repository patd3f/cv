...
\begin{itemize}%
\item Raspberry Pi - Controle d'accès à un parking par reconnaissance de plaques
  \begin{itemize}
   \item Détections des plaques minéralogiques.
   \item Controle des accès par un service externalisé.
   \item Fonctionnement autonome.
   \item IHM sous Qt
   \item Accès internet en 4G.
   \item Programmation applicatif en Python.
   \item Configuration system
   \item Distribution GNU/Linux Raspbian.
  \end{itemize}
...
\cvdoubleitem{Programmation}{GCC, GDB, JTAG}
